...
INSERT INTO "new_ShopSettings" ("accentColor", "acceptLabel", "body", "createdAt", "customizeLabel", "heading", "id", "logoUrl", "onboardingDismissed", "plan", "position", "privacyPolicyUrl", "rejectLabel", "shop", "showBranding", "subscriptionId", "themePreset", "updatedAt") SELECT "accentColor", "acceptLabel", "body", "createdAt", "customizeLabel", "heading", "id", "logoUrl", "onboardingDismissed", "plan", "position", "privacyPolicyUrl", "rejectLabel", "shop", "showBranding", "subscriptionId", "themePreset", "updatedAt" FROM "ShopSettings";
