...
CREATE TABLE "new_ShopSettings" (
    ...
    "logoUrl" TEXT,
    "logoSize" INTEGER NOT NULL DEFAULT 36,
...
INSERT INTO "new_ShopSettings" ("accentColor", "acceptLabel", "bannerWidth", "body", "borderWidth", "buttonFontSize", "createdAt", "customizeLabel", "fontFamily", "fontSize", "heading", "id", "logoUrl", "onboardingDismissed", "plan", "position", "privacyPolicyUrl", "rejectLabel", "shop", "showBranding", "subscriptionId", "themePreset", "updatedAt") SELECT "accentColor", "acceptLabel", "bannerWidth", "body", "borderWidth", "buttonFontSize", "createdAt", "customizeLabel", "fontFamily", "fontSize", "heading", "id", "logoUrl", "onboardingDismissed", "plan", "position", "privacyPolicyUrl", "rejectLabel", "shop", "showBranding", "subscriptionId", "themePreset", "updatedAt" FROM "ShopSettings";
