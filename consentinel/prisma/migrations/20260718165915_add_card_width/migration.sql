...
INSERT INTO "new_ShopSettings" ("accentColor", "acceptLabel", "bannerWidth", "body", "borderWidth", "buttonFontSize", "createdAt", "customizeLabel", "fontFamily", "fontSize", "heading", "id", "logoPosition", "logoSize", "logoUrl", "modalWidth", "onboardingDismissed", "plan", "position", "privacyPolicyUrl", "rejectLabel", "shop", "showBranding", "subscriptionId", "themePreset", "updatedAt") SELECT "accentColor", "acceptLabel", "bannerWidth", "body", "borderWidth", "buttonFontSize", "createdAt", "customizeLabel", "fontFamily", "fontSize", "heading", "id", "logoPosition", "logoSize", "logoUrl", "modalWidth", "onboardingDismissed", "plan", "position", "privacyPolicyUrl", "rejectLabel", "shop", "showBranding", "subscriptionId", "themePreset", "updatedAt" FROM "ShopSettings";
