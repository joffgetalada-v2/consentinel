...
CREATE TABLE "new_ShopSettings" (
    ...
    "cardWidth" INTEGER NOT NULL DEFAULT 400,
...
INSERT INTO "new_ShopSettings" ("accentColor", "acceptLabel", "bannerWidth", "body", "borderWidth", "buttonFontSize", "cardWidth", "createdAt", "customizeLabel", "fontFamily", "fontSize", "heading", "id", "logoPosition", "logoSize", "logoUrl", "modalWidth", "onboardingDismissed", "plan", "position", "privacyPolicyUrl", "rejectLabel", "shop", "showBranding", "subscriptionId", "themePreset", "updatedAt") SELECT "accentColor", "acceptLabel", "bannerWidth", "body", "borderWidth", "buttonFontSize", "cardWidth", "createdAt", "customizeLabel", "fontFamily", "fontSize", "heading", "id", "logoPosition", "logoSize", "logoUrl", "modalWidth", "onboardingDismissed", "plan", "position", "privacyPolicyUrl", "rejectLabel", "shop", "showBranding", "subscriptionId", "themePreset", "updatedAt" FROM "ShopSettings";
